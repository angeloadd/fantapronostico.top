        ...
        <div class="card-body">
            <div class="w-full px-0 px-lg-5">
                <ul class="  row-span-12">
                    <li class=" col-span-5 col-sm-2 title-font text-bold">Nome Giocatore</li>
                    ...
                    <li class=" col-2 sm:hidden text-2xl">
                    ...
                    <li class=" col-span-5 col-sm-3 title-font text-bold">Ultimo Update</li>
                </ul>
                @foreach($sortedBets as $key => $bet)
                    <ul class="  row-span-12">
                        <li class=" col-span-5 col-sm-2 @if(Auth::user()?->id === $bet->user->id) bg-secondary text-base-100 @elseif($key%2 === 0) bg-primary text-base-100 @else bg-white text-dark @endif">
                        ...
                        <li class=" hidden d-sm-inline col-1 @if(Auth::user()?->id === $bet->user->id) bg-secondary text-base-100 @elseif($key%2 === 0) bg-primary text-base-100 @else bg-white text-dark @endif">
                            {{$bet->sign}}
                        </li>
                        <li class=" hidden d-sm-inline col-2 @if(Auth::user()?->id === $bet->user->id) bg-secondary text-base-100 @elseif($key%2 === 0) bg-primary text-base-100 @else bg-white text-dark @endif">
                            {{$bet->home_result}} a {{$bet->away_result}}
                        </li>
                        <li class=" col-2 sm:hidden @if(Auth::user()?->id === $bet->user->id) bg-secondary text-base-100 @elseif($key%2 === 0) bg-primary text-base-100 @else bg-white text-dark @endif">
                        ...
                        <li class=" col-span-5 col-sm-3 @if(Auth::user()?->id === $bet->user->id) bg-secondary text-base-100 @elseif($key%2 === 0) bg-primary text-base-100 @else bg-white text-dark @endif"
                    ...
                    <div class="row-span-12 justify-center mb-2">
                        ...
                        <div
                            class="m-0 sm:hidden title-font @if(Auth::user()?->id === $bet->user->id) bg-secondary text-base-100 @elseif($key%2 === 0) bg-primary text-base-100 @else bg-white text-dark @endif border border-end-0 border-1 border-info">
                            Gol NoGol
                        </div>
                        <div
