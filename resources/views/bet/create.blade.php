                ...
                <form action="{{route('bet.store', compact('game'))}}" method="POST">
                    ...
                    <div class="justify-center items-center flex-col w-full px-1">
                        ...
                        <div
                            ...
                            <div class="text-dark w-100 text-center my-3 px-0">
                        ...
                        <div
                            ...
                            <div
                                class="form-check flex justify-content-start items-center">
                        ...
                        <div
                            ...
                            <div class="text-dark w-100 text-center my-3">Inserisci Pronostico
