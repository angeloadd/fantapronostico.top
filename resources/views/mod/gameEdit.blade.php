                ...
                <div class="card text-dark bg-light mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('mod.gameUpdate', compact('game'))}}" method="POST">
                            ...
                            <div
                                class="mb-3 row justify-center items-center border border-info border-1 pb-4 px-2 rounded-md shadow-lg">
                                <div class="text-dark w-100 text-center col-12 my-3 px-0">Inserisci il risultato esatto
        ...
        @push('scripts')
            <script>
                ...
                function selectGolHome() {
                    ...
                    <div class="px-md-2 px-0 flex justify-center items-center position-relative" id="homeScoreContainer">
                    ...
                    <div class="px-md-2 px-0 flex justify-center items-center position-relative" id="homeScore${i}Container">
...
@error('homeScore')
                ...
                function selectGolAway() {
                    ...
                    <div class="px-md-2 px-0 flex justify-center items-center position-relative" id="awayScoreContainer">
                    ...
                    <div class="px-md-2 px-0 flex justify-center items-center position-relative" id="awayScore${i}Container">
