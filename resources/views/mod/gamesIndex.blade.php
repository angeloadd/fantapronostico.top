            ...
            <div class="col-12">
                <div class="container-fluid">
                    <ul class="  row">
                        ...
                        <li class=" col-4 col-sm-2 px-0 px-sm-1">Partita</li>
                        <li class=" col-sm-2 px-0 px-sm-1">Risultato</li>
                        <li class=" col-2 col-sm-1 px-0 px-sm-1">segno</li>
                        <li class=" col-4 hidden sm:flex px-0 px-sm-1">Cartellino</li>
                        <li class=" col-sm-2 px-0 px-sm-1">Modifica</li>
                    </ul>
                    @foreach($games as $number => $game)
                        <ul class="  row">
                            <li class=" col-1 px-0 px-sm-1 title-font hidden sm:flex">
                                @if($game->isFinal())
                                    FINALE
                                @else
                                    {{$number+1}}
                            ...
                            <li class=" col-4 col-sm-2 px-0 px-sm-1">{{$game->home_team}}
                                vs {{$game->away_team}}</li>
                            <li class=" col-sm-2 px-0 px-sm-1">{{$game->home_result ?? 'N/A'}}
                                - {{$game->away_result ?? 'N/A'}}</li>
                            <li class=" col-2 col-sm-1 px-0 px-sm-1">{{$game->sign ?? 'N/A'}}</li>
                            <li class=" col-2 px-0 px-sm-1 hidden sm:flex">
