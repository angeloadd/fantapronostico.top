<x-layouts.with-drawer>
    ...
    <div class="tab-content p-3" id="myTabContent">
                        ...
                        <div class="container px-0 px-xl-5">
                            <div class="row">
                                <div class="col-lg-8 border rounded-lg">
                                    ...
                                    <p class="m-0 text-center">Risultato 90/120:
                                        <br class="md:hidden">{{$bet->game->home_result}} - {{$bet->game->away_result}} ({{$bet->game->sign}})
                                    </p>
                                </div>
        ...
        <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
            ...
            @if(\App\Models\Tournament::first()?->final_started_at->isPast())
                <p>
                    <span class="text-2xl fp2024-title">Info Pronostico Finale:</span>
                    <span class="text-2xl">{{$userRank->finalBetTotal() ?: 'N/A'}} pronosticato in data e ora: {{\Carbon\Carbon::createFromTimestamp($userRank->finalBetTimestamp())->format(\App\Helpers\Constants::DISPLAY) ?: 'N/A'}}</span>
                </p>
            @endif
            <p>
